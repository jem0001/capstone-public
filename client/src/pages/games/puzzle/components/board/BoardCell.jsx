...
const BoardCell = ({
   ...
   */
  const { game, play, size, puzzleImage, openModal } = useContext(GameContext);
    ...
    <div
      ...
      onClick={() => {
        if (
          ...
          !game.gameWon &&
          !game.gameLost &&
          game.moves.length % 5 === 0
        ) {
          // Ask question
          openModal(x, y);
        } else if (canPlay && !game.gameWon && !game.gameLost) {
          // immediately move piece
          play(x, y);
        }
      }}>
      <div
