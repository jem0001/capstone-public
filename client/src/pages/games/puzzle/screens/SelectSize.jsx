 ...
 */
const sizeList = [
  { name: "Easy", sizeOption: "3x3" }, // Add 3x3 option
...
const SelectSize = () => {
  ...
  return (
    <>
      <SelectionGroupLayout label="Select Layout" className="md:grid-cols-1">
        <SelectionIconButton
      ...
      <div className="flex flex-wrap justify-center items-center">
        <div className="flex justify-center items-center">
          <ControlButton onClick={() => navigate("/activities/week-1/puzzle")}>
            Go To Game
          </ControlButton>
        </div>
      </div>
